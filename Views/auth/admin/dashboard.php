...
<?php 
// Pastikan path config benar (keluar 3 folder: admin -> auth -> Views -> root)
include_once '../../../app/core/assets/config.php'; 
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        /* CSS Tambahan untuk Responsivitas Sidebar */
        .sidebar {
            min-height: 100vh;
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 bg-light">
            ...
            <div class="card shadow-sm animate__animated animate__fadeInUp">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold">Daftar Pesanan Terbaru</h5>
                </div>
                <div class="card-body">
